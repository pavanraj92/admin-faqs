...
{
    protected $signature = 'faqs:test-views';
    protected $description = 'Test view resolution for Faqs module';

    public function handle()
    {
        $this->info('🔍 Testing View Resolution for Faqs Module...');
        ...
        foreach ($testViews as $viewName) {
            ...
            $namespaces = [
                'faqs-module::' . $viewName => 'Module View',
                'faq::' . $viewName => 'Package View',
            ];
        ...
        $controller = new \Modules\Faqs\app\Http\Controllers\Admin\FaqManagerController();
        ...
        $this->info("\n📋 View Loading Order:");
        $this->info("1. faqs-module:: (Module views - highest priority)");
        $this->info("2. faq:: (Package views - fallback)");
        
        $this->info("\n💡 Tips:");
        $this->info("- Edit views in Modules/Faqs/resources/views/ to use module views");
